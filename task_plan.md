...
- [x] Hashtags/tags
- [x] Tables (stored as attachments, markdown-to-HTML conversion added)
- **Status:** complete
...
- [x] Update ROADMAP.md
- [x] Test tables (stored as attachments, markdown conversion working)
...
**Tables tested and markdown support added:**
- [x] Tables stored as embedded attachments (com.apple.notes.table)
- [x] Plain text read shows placeholder character (￼)
- [x] HTML read returns full table via AppleScript
- [x] Markdown table syntax (| col | col |) now converts to native tables
- [x] Tables created via HTML are preserved in Notes.app
